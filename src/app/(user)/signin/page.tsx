                ...
                <div className="mb-5 mt-6">
                    ...
                    <div className="flex justify-center items-center gap-3 mt-2">
                        <form
                            ...
                            className="flex items-center gap-1 border border-accent font-semibold bg-slate-50 px-2 py-1.5 rounded-md hover:bg-blue-800 hover:text-white duration-300 ease-in-out"
                        >
